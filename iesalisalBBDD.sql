DROP DATABASE IF EXISTS iesalisal;
CREATE DATABASE iesalisal CHARACTER SET utf8mb4;
USE iesalisal;
...
INSERT INTO departamento VALUES (2, 'Estetica');
INSERT INTO departamento VALUES (3, 'Imagen integral');
INSERT INTO departamento VALUES (4, 'Administracion y finanzas');
INSERT INTO departamento VALUES (5, 'Ciencias y Tecnologia');
INSERT INTO departamento VALUES (6, 'Sistemas Microinformáticos y Redes');
INSERT INTO departamento VALUES (7, 'Asistencia a la Dirección');
INSERT INTO departamento VALUES (8, 'Ciberseguridad');
INSERT INTO departamento VALUES (9, 'Peluquería');
...
/* Grado */
INSERT INTO grado VALUES (1, 'Grado en Informatica');
INSERT INTO grado VALUES (2, 'Grado en Estética Integral y Bienestar');
INSERT INTO grado VALUES (3, 'Grado en Sistemas Microinformáticos y Redes');
INSERT INTO grado VALUES (4, 'Grado en Administracion y Finanzas');
INSERT INTO grado VALUES (5, 'Grado en Ingeniería Mecánica (Plan 2010)');
INSERT INTO grado VALUES (6, 'Grado en Administración de Sistemas Informáticos en Red');
INSERT INTO grado VALUES (7, 'Grado en Asistencia a la Dirección');
INSERT INTO grado VALUES (8, 'Grado en Ciberseguridad en Entornos de las Tecnologías de la información');
INSERT INTO grado VALUES (9, 'Grado en Peluqueria y estetica');
INSERT INTO grado VALUES (10, 'Grado en Humanidades y ciencias');
...
INSERT INTO asignatura VALUES (54, 'Estetica I', 6, 'básica', 1, 1, NULL, 7);
...
INSERT INTO asignatura VALUES (60, 'Estetica II', 6, 'básica', 1, 2, NULL, 7);
...
INSERT INTO alumno_matricula VALUES (1, 1, 1);
INSERT INTO alumno_matricula VALUES (1, 2, 1);
INSERT INTO alumno_matricula VALUES (1, 3, 1);
INSERT INTO alumno_matricula VALUES (1, 4, 1);
INSERT INTO alumno_matricula VALUES (1, 5, 1);
INSERT INTO alumno_matricula VALUES (1, 6, 1);
INSERT INTO alumno_matricula VALUES (1, 7, 1);
INSERT INTO alumno_matricula VALUES (1, 8, 1);
INSERT INTO alumno_matricula VALUES (1, 9, 1);
INSERT INTO alumno_matricula VALUES (1, 10, 1);

INSERT INTO alumno_matricula VALUES (1, 1, 2);
INSERT INTO alumno_matricula VALUES (1, 2, 2);
INSERT INTO alumno_matricula VALUES (1, 3, 2);

INSERT INTO alumno_matricula VALUES (1, 1, 3);
INSERT INTO alumno_matricula VALUES (1, 2, 3);
INSERT INTO alumno_matricula VALUES (1, 3, 3);

INSERT INTO alumno_matricula VALUES (1, 1, 4);
INSERT INTO alumno_matricula VALUES (1, 2, 4);
INSERT INTO alumno_matricula VALUES (1, 3, 4);

INSERT INTO alumno_matricula VALUES (2, 1, 1);
INSERT INTO alumno_matricula VALUES (2, 2, 1);
INSERT INTO alumno_matricula VALUES (2, 3, 1);

INSERT INTO alumno_matricula VALUES (4, 1, 1);
INSERT INTO alumno_matricula VALUES (4, 2, 1);
INSERT INTO alumno_matricula VALUES (4, 3, 1);

INSERT INTO alumno_matricula VALUES (4, 1, 2);
INSERT INTO alumno_matricula VALUES (4, 2, 2);
INSERT INTO alumno_matricula VALUES (4, 3, 2);
INSERT INTO alumno_matricula VALUES (4, 4, 2);
INSERT INTO alumno_matricula VALUES (4, 5, 2);
INSERT INTO alumno_matricula VALUES (4, 6, 2);
INSERT INTO alumno_matricula VALUES (4, 7, 2);
INSERT INTO alumno_matricula VALUES (4, 8, 2);
INSERT INTO alumno_matricula VALUES (4, 9, 2);
INSERT INTO alumno_matricula VALUES (4, 10, 2);